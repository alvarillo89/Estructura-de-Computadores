...
int main(){
    ...
    crono(popcount1, "popcount(lenguaje C -      for)");
    crono(popcount2, "popcount(lenguaje C -    while)");
		crono(popcount3, "popcount(ensamblador -   while)");
		crono(popcount4, "popcount(lenguaje C -  máscara)");
		crono(popcount5, "popcount(C-ASM - Versión SSSE3)");
